...
)
{
    ...
    {
        struct q4_repack_2x8_fp16 * B_ptr0 = B_ptr_start + j * nb_k;
        ...
        for (int blk_id = 0; blk_id < nb_k; blk_id++)
        {
            ...
            __m256i low_blk_B_packs0[8];
            __m256i high_blk_B_packs0[8];
            __m256i low_blk_B_packs1[8];
            __m256i high_blk_B_packs1[8];
            for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
            {
                ...
                __m256i low_blk_B_pack0 = _mm256_and_si256(B_coupled_pack0, _mm256_set1_epi8(0x0f));
                __m256i high_blk_B_pack0 = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack0, 4), _mm256_set1_epi8(0x0f));
                low_blk_B_packs0[pack_idx] = low_blk_B_pack0;
                high_blk_B_packs0[pack_idx] = high_blk_B_pack0;
                __m256i B_coupled_pack1 = _mm256_loadu_si256((__m256i *) (B_block1.q_coupled + pack_idx * 32));
                __m256i low_blk_B_pack1 = _mm256_and_si256(B_coupled_pack1, _mm256_set1_epi8(0x0f));
                __m256i high_blk_B_pack1 = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack1, 4), _mm256_set1_epi8(0x0f));
                low_blk_B_packs1[pack_idx] = low_blk_B_pack1;
                high_blk_B_packs1[pack_idx] = high_blk_B_pack1;
            }
            // Process single row of A
            ...
            // Accumulate results for block 0
            ...
            // Accumulate results for block 1
        ...
        _mm256_storeu_ps(C + j * 8, acc_row0);
