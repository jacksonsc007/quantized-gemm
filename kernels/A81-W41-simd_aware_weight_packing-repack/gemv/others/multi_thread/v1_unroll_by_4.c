...
)
{
    ...
    {
        struct q4_repack_2x8_fp16 * B_ptr0 = B_ptr_start + (j + 0) * nb_k;
        struct q4_repack_2x8_fp16 * B_ptr1 = B_ptr_start + (j + 1) * nb_k;
        struct q4_repack_2x8_fp16 * B_ptr2 = B_ptr_start + (j + 2) * nb_k;
        struct q4_repack_2x8_fp16 * B_ptr3 = B_ptr_start + (j + 3) * nb_k;
        ...
        {
            struct q4_repack_2x8_fp16 B_block0 = B_ptr0[blk_id];
            struct q4_repack_2x8_fp16 B_block1 = B_ptr1[blk_id];
            struct q4_repack_2x8_fp16 B_block2 = B_ptr2[blk_id];
            struct q4_repack_2x8_fp16 B_block3 = B_ptr3[blk_id];
            // each pack contains 4 elements in the quantization block
            __m256i low_blk_B_packs0[8], high_blk_B_packs0[8];
            __m256i low_blk_B_packs1[8], high_blk_B_packs1[8];
            __m256i low_blk_B_packs2[8], high_blk_B_packs2[8];
            __m256i low_blk_B_packs3[8], high_blk_B_packs3[8];
            for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
            {
                // block 0
                __m256i B_coupled_pack0 = _mm256_loadu_si256((__m256i *) (B_block0.q_coupled + pack_idx * 32));
                low_blk_B_packs0[pack_idx] = _mm256_and_si256(B_coupled_pack0, _mm256_set1_epi8(0x0f));
                high_blk_B_packs0[pack_idx] = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack0, 4), _mm256_set1_epi8(0x0f));
                // block 1
                __m256i B_coupled_pack1 = _mm256_loadu_si256((__m256i *) (B_block1.q_coupled + pack_idx * 32));
                low_blk_B_packs1[pack_idx] = _mm256_and_si256(B_coupled_pack1, _mm256_set1_epi8(0x0f));
                high_blk_B_packs1[pack_idx] = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack1, 4), _mm256_set1_epi8(0x0f));
                // block 2
                __m256i B_coupled_pack2 = _mm256_loadu_si256((__m256i *) (B_block2.q_coupled + pack_idx * 32));
                low_blk_B_packs2[pack_idx] = _mm256_and_si256(B_coupled_pack2, _mm256_set1_epi8(0x0f));
                high_blk_B_packs2[pack_idx] = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack2, 4), _mm256_set1_epi8(0x0f));
                // block 3
                __m256i B_coupled_pack3 = _mm256_loadu_si256((__m256i *) (B_block3.q_coupled + pack_idx * 32));
                low_blk_B_packs3[pack_idx] = _mm256_and_si256(B_coupled_pack3, _mm256_set1_epi8(0x0f));
                high_blk_B_packs3[pack_idx] = _mm256_and_si256(_mm256_srli_epi16(B_coupled_pack3, 4), _mm256_set1_epi8(0x0f));
            }
            // Process single row of A
            ...
            __m256i iacc_low0 = _mm256_setzero_si256(), iacc_high0 = _mm256_setzero_si256();
            __m256i iacc_low1 = _mm256_setzero_si256(), iacc_high1 = _mm256_setzero_si256();
            __m256i iacc_low2 = _mm256_setzero_si256(), iacc_high2 = _mm256_setzero_si256();
            __m256i iacc_low3 = _mm256_setzero_si256(), iacc_high3 = _mm256_setzero_si256();
            for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
            {
                iacc_low0  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low0 , low_blk_B_packs0  [ pack_idx ] , low_blk_A_packs  [ pack_idx ]); 
                iacc_high0 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high0, high_blk_B_packs0 [ pack_idx ] , high_blk_A_packs [ pack_idx ]); 
                iacc_low1  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low1 , low_blk_B_packs1  [ pack_idx ] , low_blk_A_packs  [ pack_idx ]); 
                iacc_high1 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high1, high_blk_B_packs1 [ pack_idx ] , high_blk_A_packs [ pack_idx ]); 
                iacc_low2  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low2 , low_blk_B_packs2  [ pack_idx ] , low_blk_A_packs  [ pack_idx ]); 
                iacc_high2 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high2, high_blk_B_packs2 [ pack_idx ] , high_blk_A_packs [ pack_idx ]); 
                iacc_low3  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low3 , low_blk_B_packs3  [ pack_idx ] , low_blk_A_packs  [ pack_idx ]); 
                iacc_high3 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high3, high_blk_B_packs3 [ pack_idx ] , high_blk_A_packs [ pack_idx ]); 
            }
            ...
            __m256 minB_low0 = _mm256_loadu_ps(B_block0.min_low);
            __m256 minB_high0 = _mm256_loadu_ps(B_block0.min_high);
            ...
            acc_row0 = _mm256_fmadd_ps(minB_low0, scaled_sum_low, acc_row0);
            acc_row0 = _mm256_fmadd_ps(minB_high0, scaled_sum_high, acc_row0);
            // block 1
            __m256 sB_low1 = _mm256_loadu_ps(B_block1.s_low);
            __m256 sB_high1 = _mm256_loadu_ps(B_block1.s_high);
            __m256 minB_low1 = _mm256_loadu_ps(B_block1.min_low);
            __m256 minB_high1 = _mm256_loadu_ps(B_block1.min_high);
            ...
            acc_row1 = _mm256_fmadd_ps(minB_low1, scaled_sum_low, acc_row1);
            acc_row1 = _mm256_fmadd_ps(minB_high1, scaled_sum_high, acc_row1);
            // block 2
            __m256 sB_low2 = _mm256_loadu_ps(B_block2.s_low);
            __m256 sB_high2 = _mm256_loadu_ps(B_block2.s_high);
            __m256 minB_low2 = _mm256_loadu_ps(B_block2.min_low);
            __m256 minB_high2 = _mm256_loadu_ps(B_block2.min_high);
            ...
            acc_row2 = _mm256_fmadd_ps(minB_low2, scaled_sum_low, acc_row2);
            acc_row2 = _mm256_fmadd_ps(minB_high2, scaled_sum_high, acc_row2);
            // block 3
            __m256 sB_low3 = _mm256_loadu_ps(B_block3.s_low);
            __m256 sB_high3 = _mm256_loadu_ps(B_block3.s_high);
            __m256 minB_low3 = _mm256_loadu_ps(B_block3.min_low);
            __m256 minB_high3 = _mm256_loadu_ps(B_block3.min_high);
            ...
            acc_row3 = _mm256_fmadd_ps(minB_low3, scaled_sum_low, acc_row3);
            acc_row3 = _mm256_fmadd_ps(minB_high3, scaled_sum_high, acc_row3);
        }
        _mm256_storeu_ps(C + (j + 0) * 8, acc_row0);
        _mm256_storeu_ps(C + (j + 1) * 8, acc_row1);
        _mm256_storeu_ps(C + (j + 2) * 8, acc_row2);
        _mm256_storeu_ps(C + (j + 3) * 8, acc_row3);
    }
}
...
int main() {
    ...
    */
    ...
    struct q8_repack_1x2_fp16 * A_repack_start = (struct q8_repack_1x2_fp16 *) A_repack;
    for (int i = 0; i < M; i++) 
    {
        struct q8_repack_1x2_fp16 * A_ptr = A_repack_start + i * num_repack_blk_A_along_K;
    ...
    for (int i = 0; i < M; i++) 
    {
        ...
        {
            struct q8_repack_1x2_fp16 * A_ptr = A_repack_start + i * num_repack_blk_A_along_K + j;
