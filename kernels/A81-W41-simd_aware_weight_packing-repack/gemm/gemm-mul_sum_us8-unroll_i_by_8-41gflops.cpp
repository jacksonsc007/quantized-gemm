...
)
{
    ...
    for (int i = 0; i < nb_m; i += 8)
    {
        ...
        struct q80_repack_1x2 * A_ptr_next4 = A_ptr_start + (i + 4) * nb_k;
        struct q80_repack_1x2 * A_ptr_next5 = A_ptr_start + (i + 5) * nb_k;
        struct q80_repack_1x2 * A_ptr_next6 = A_ptr_start + (i + 6) * nb_k;
        struct q80_repack_1x2 * A_ptr_next7 = A_ptr_start + (i + 7) * nb_k;
        ...
        for(int j = 0; j < nb_n; j++)
        {
            ...
            for (int blk_id = 0; blk_id < nb_k; blk_id++)
            {
                ...
                // Process eight rows of A simultaneously
                ...
                __m256i low_blk_A_packs_next6[8];
                __m256i high_blk_A_packs_next6[8];
                __m256i low_blk_A_packs_next7[8];
                __m256i high_blk_A_packs_next7[8];
                ...
                for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
                {
                    ...
                    low_blk_A_packs_next6[pack_idx] = _mm256_set1_epi32(( (int32_t *)(A_ptr_next6[blk_id].q_low) )[pack_idx]);
                    high_blk_A_packs_next6[pack_idx] = _mm256_set1_epi32(( (int32_t *)(A_ptr_next6[blk_id].q_high) )[pack_idx]);
                    low_blk_A_packs_next7[pack_idx] = _mm256_set1_epi32(( (int32_t *)(A_ptr_next7[blk_id].q_low) )[pack_idx]);
                    high_blk_A_packs_next7[pack_idx] = _mm256_set1_epi32(( (int32_t *)(A_ptr_next7[blk_id].q_high) )[pack_idx]);
                }
                ...
                for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
                {
                    ...
                    iacc_low6  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low6 , low_blk_B_packs  [ pack_idx ] , low_blk_A_packs_next6  [ pack_idx ]); 
                    iacc_high6 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high6, high_blk_B_packs [ pack_idx ] , high_blk_A_packs_next6 [ pack_idx ]); 
                    iacc_low7  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low7 , low_blk_B_packs  [ pack_idx ] , low_blk_A_packs_next7  [ pack_idx ]); 
                    iacc_high7 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high7, high_blk_B_packs [ pack_idx ] , high_blk_A_packs_next7 [ pack_idx ]); 
                }
                ...
                __m256 sA_low_next6 = _mm256_set1_ps(A_ptr_next6[blk_id].s_low);
                __m256 sA_high_next6 = _mm256_set1_ps(A_ptr_next6[blk_id].s_high);
                __m256 scaled_sum_low_next6 = _mm256_set1_ps(A_ptr_next6[blk_id].scaled_sum_low);
                __m256 scaled_sum_high_next6 = _mm256_set1_ps(A_ptr_next6[blk_id].scaled_sum_high);

                __m256 sA_low_next7 = _mm256_set1_ps(A_ptr_next7[blk_id].s_low);
                __m256 sA_high_next7 = _mm256_set1_ps(A_ptr_next7[blk_id].s_high);
                __m256 scaled_sum_low_next7 = _mm256_set1_ps(A_ptr_next7[blk_id].scaled_sum_low);
                __m256 scaled_sum_high_next7 = _mm256_set1_ps(A_ptr_next7[blk_id].scaled_sum_high);
                ...
                __m256 s_low_next6 = _mm256_mul_ps(sA_low_next6, sB_low);
                __m256 s_high_next6 = _mm256_mul_ps(sA_high_next6, sB_high);
                __m256 s_low_next7 = _mm256_mul_ps(sA_low_next7, sB_low);
                __m256 s_high_next7 = _mm256_mul_ps(sA_high_next7, sB_high);
                ...
                // Seventh row
                acc_row6 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_low6), s_low_next6, acc_row6);
                acc_row6 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_high6), s_high_next6, acc_row6);
                acc_row6 = _mm256_fmadd_ps(minB_low, scaled_sum_low_next6, acc_row6);
                acc_row6 = _mm256_fmadd_ps(minB_high, scaled_sum_high_next6, acc_row6);

                // Eighth row
                acc_row7 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_low7), s_low_next7, acc_row7);
                acc_row7 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_high7), s_high_next7, acc_row7);
                acc_row7 = _mm256_fmadd_ps(minB_low, scaled_sum_low_next7, acc_row7);
                acc_row7 = _mm256_fmadd_ps(minB_high, scaled_sum_high_next7, acc_row7);
            }
