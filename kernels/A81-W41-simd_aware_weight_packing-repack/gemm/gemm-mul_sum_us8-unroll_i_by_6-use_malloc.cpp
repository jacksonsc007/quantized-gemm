...
int main() {
    ...
    float* C_ref = (float*)malloc(M * N * sizeof(float)); // malloc may not guarantee 64-byte alignment
    ...
    */
    void * A_repack  = malloc(M * K * sizeof(float));
    void * B_repack  = malloc(K * N * sizeof(float));
