    ...
    for (int i = 0; i < nb_m; i += 4)
    {
        ...
        for(int j = 0; j < nb_n; j++)
        {
            ...
            for (int blk_id = 0; blk_id < nb_k; blk_id++)
            {
                ...
                __m256i low_blk_B_pack ;
                __m256i high_blk_B_pack;               
                __m256i low_blk_A_pack_0;
                __m256i high_blk_A_pack_0;
                __m256i low_blk_A_pack_1;
                __m256i high_blk_A_pack_1;
                for (int pack_idx = 0; pack_idx < 8; pack_idx+=1)
                {
                    low_blk_B_pack = low_blk_B_packs[pack_idx];
                    high_blk_B_pack = high_blk_B_packs[pack_idx];

                    low_blk_A_pack_0 = low_blk_A_packs[pack_idx];
                    high_blk_A_pack_0 = high_blk_A_packs[pack_idx];
                    iacc_low0  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low0 , low_blk_B_pack ,low_blk_A_pack_0); 
                    iacc_high0 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high0, high_blk_B_pack , high_blk_A_pack_0); 
                
                    low_blk_A_pack_1 = low_blk_A_packs_next[pack_idx];
                    high_blk_A_pack_1 = high_blk_A_packs_next[pack_idx];
                    iacc_low1  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low1 , low_blk_B_pack , low_blk_A_pack_1); 
                    iacc_high1 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high1, high_blk_B_pack , high_blk_A_pack_1); 

                    low_blk_A_pack_0 = low_blk_A_packs_next2[pack_idx];
                    high_blk_A_pack_0 = high_blk_A_packs_next2[pack_idx];
                    iacc_low2  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low2 , low_blk_B_pack , low_blk_A_pack_0); 
                    iacc_high2 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high2, high_blk_B_pack , high_blk_A_pack_0); 
                
                    low_blk_A_pack_1 = low_blk_A_packs_next3[pack_idx];
                    high_blk_A_pack_1 = high_blk_A_packs_next3[pack_idx];
                    iacc_low3  = mul_sum_us8_pairs_acc_int32x8 ( iacc_low3 , low_blk_B_pack , low_blk_A_pack_1); 
                    iacc_high3 = mul_sum_us8_pairs_acc_int32x8 ( iacc_high3, high_blk_B_pack , high_blk_A_pack_1); 
                }
