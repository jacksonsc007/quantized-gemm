    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
    ...
    for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
    {
        ...
        float fused_s_0000 = sA_00 * sB_00;
        float fused_s_0110 = sA_01 * sB_10;
        float fused_s_0001 = sA_00 * sB_01;
        float fused_s_0111 = sA_01 * sB_11;

        float fused_s_1000 = sA_10 * sB_00;
        float fused_s_1110 = sA_11 * sB_10;
        float fused_s_1001 = sA_10 * sB_01;
        float fused_s_1111 = sA_11 * sB_11;
        ...
        sum00 = _mm256_fmadd_ps(t00, _mm256_set1_ps(fused_s_0000), sum00);
        sum00 = _mm256_fmadd_ps(t01, _mm256_set1_ps(fused_s_0110), sum00);

        // i = 0, j = 1
        __m256 t10 = mul_sum_i8_pairs_float(a00, b01);  // same a00
        __m256 t11 = mul_sum_i8_pairs_float(a01, b11);
        sum01 = _mm256_fmadd_ps(t10, _mm256_set1_ps(fused_s_0001), sum01);
        sum01 = _mm256_fmadd_ps(t11, _mm256_set1_ps(fused_s_0111), sum01);

        // i = 1, j = 0
        __m256 t20 = mul_sum_i8_pairs_float(a10, b00);
        __m256 t21 = mul_sum_i8_pairs_float(a11, b10);
        sum10 = _mm256_fmadd_ps(t20, _mm256_set1_ps(fused_s_1000), sum10);
        sum10 = _mm256_fmadd_ps(t21, _mm256_set1_ps(fused_s_1110), sum10);

        // i = 1, j = 1
        __m256 t30 = mul_sum_i8_pairs_float(a10, b01);
        __m256 t31 = mul_sum_i8_pairs_float(a11, b11);
        sum11 = _mm256_fmadd_ps(t30, _mm256_set1_ps(fused_s_1001), sum11);
        sum11 = _mm256_fmadd_ps(t31, _mm256_set1_ps(fused_s_1111), sum11);
    }
