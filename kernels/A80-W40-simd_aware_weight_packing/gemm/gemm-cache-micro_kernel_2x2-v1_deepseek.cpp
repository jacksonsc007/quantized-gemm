    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
    // i=0, j=0
    {
        ...
        for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
        {
            ...
            float sA_1_0 = *blockSA(0, block_idx + 1, block_k/Q_BLK_SIZE);
            float sB_1_0 = *blockSB(block_idx + 1, 0, block_k/Q_BLK_SIZE);
            float fused_s_0_00 = sA_0_0 * sB_0_0;
            float fused_s_1_00 = sA_1_0 * sB_1_0;

            __m256i a_pack_int8_low_0 = _mm256_loadu_si256((__m256i *) blockA(0, p, block_k));
            __m256i a_pack_int8_high_0 = _mm256_loadu_si256((__m256i *) blockA(0, p + Q_BLK_SIZE, block_k));
            ...
            __m256 tmp_0_00 = mul_sum_i8_pairs_float(a_pack_int8_low_0, b_pack_int8_low_0);
            __m256 tmp_1_00 = mul_sum_i8_pairs_float(a_pack_int8_high_0, b_pack_int8_high_0);
        ...
        *C(0, 0, NDIM) += hsum_float_8(sum_packed_fp_00);
    }
    ...
    // i=0, j=1
    {
        ...
        for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
        {
            int block_idx = p / Q_BLK_SIZE;
            float sA_0_0 = *blockSA(0, block_idx, block_k/Q_BLK_SIZE);
            float sB_0_1 = *blockSB(block_idx, 1, block_k/Q_BLK_SIZE);
            float sA_1_0 = *blockSA(0, block_idx + 1, block_k/Q_BLK_SIZE);
            ...
            __m256 tmp_0_01 = mul_sum_i8_pairs_float(a_pack_int8_low_0, b_pack_int8_low_1);
            __m256 tmp_1_01 = mul_sum_i8_pairs_float(a_pack_int8_high_0, b_pack_int8_high_1);
        ...
        *C(0, 1, NDIM) += hsum_float_8(sum_packed_fp_01);
    }
    ...
    // i=1, j=0
    {
        ...
        {
            int block_idx = p / Q_BLK_SIZE;
            float sA_0_1 = *blockSA(1, block_idx, block_k/Q_BLK_SIZE);
            float sB_0_0 = *blockSB(block_idx, 0, block_k/Q_BLK_SIZE);
            ...
            __m256i a_pack_int8_low_1 = _mm256_loadu_si256((__m256i *) blockA(1, p, block_k));
            __m256i a_pack_int8_high_1 = _mm256_loadu_si256((__m256i *) blockA(1, p + Q_BLK_SIZE, block_k));
            ...
            __m256 tmp_0_10 = mul_sum_i8_pairs_float(a_pack_int8_low_1, b_pack_int8_low_0);
            __m256 tmp_1_10 = mul_sum_i8_pairs_float(a_pack_int8_high_1, b_pack_int8_high_0);
        ...
        *C(1, 0, NDIM) += hsum_float_8(sum_packed_fp_10);
    }
    ...
    // i=1, j=1
    {
        ...
        for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
        {
            ...
            __m256 tmp_0_11 = mul_sum_i8_pairs_float(a_pack_int8_low_1, b_pack_int8_low_1);
            __m256 tmp_1_11 = mul_sum_i8_pairs_float(a_pack_int8_high_1, b_pack_int8_high_1);
        ...
        *C(1, 1, NDIM) += hsum_float_8(sum_packed_fp_11);
    }
}
