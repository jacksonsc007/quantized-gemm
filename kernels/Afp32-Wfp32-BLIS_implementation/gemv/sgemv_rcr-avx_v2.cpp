...
r: register level
*/
void kernel_per_thread(float* A, float* B, float* C, const int N, const int K, const int start_col, const int end_col) {
...
void matmul_kernel(float* A, float* B, float* C, const int N, const int K)
{
    ...
    #pragma omp parallel num_threads(NTHREADS)
    {
        ...
        kernel_per_thread(A, B, C, N, K, start_col, end_col);
    }
}
