...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_1_ink] = {
        .from_float               = quantize_row_q4_1_ink,
        .vec_dot                  = ggml_vec_dot_q4_1_q8_1_ink,
        .vec_dot_type             = GGML_TYPE_Q8_1_ink,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_1_ink_fp32] = {
        .from_float               = quantize_row_q4_1_ink_fp32,
        .vec_dot                  = ggml_vec_dot_q4_1_q8_1_ink_fp32,
        .vec_dot_type             = GGML_TYPE_Q8_1_ink_fp32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_0_ink] = {
        .from_float               = quantize_row_q4_0_ink,
        .vec_dot                  = ggml_vec_dot_q4_0_q8_0_ink,
        .vec_dot_type             = GGML_TYPE_Q8_0_ink,
        .nrows                    = 1,
    },
};
