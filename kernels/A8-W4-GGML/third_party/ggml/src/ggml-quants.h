...
// NOTE: ink modified
GGML_API size_t quantize_q4_1_ink(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q4_1_ink_fp32(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q8_1_ink(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q8_1_ink_fp32(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API void quantize_row_q4_1_ink_ref(const float * GGML_RESTRICT x, block_q4_1_ink * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q4_1_ink_fp32_ref(const float * GGML_RESTRICT x, block_q4_1_ink_fp32 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q8_1_ink(const float * GGML_RESTRICT x, block_q8_1_ink * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q8_1_ink_fp32(const float * GGML_RESTRICT x, block_q8_1_ink_fp32 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q4_1_ink(const block_q4_1_ink * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q4_1_ink_fp32(const block_q4_1_ink_fp32 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);

GGML_API void quantize_row_q4_0_ink_ref(const float * GGML_RESTRICT x, block_q4_0_ink * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q4_0_ink(const block_q4_0_ink * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_0_ink(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API void quantize_row_q8_0_ink_ref(const float * GGML_RESTRICT x, block_q8_0_ink * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_q8_0_ink(const block_q8_0_ink * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q8_0_ink(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
