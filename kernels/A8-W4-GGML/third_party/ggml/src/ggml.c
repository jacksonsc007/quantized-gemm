...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q8_1_ink] = { // GGML_TYPE_IQ4_NL_8_8
        .type_name                = "q8_1_ink",
        .blck_size                = QK8_1_ink,
        .type_size                = sizeof(block_q8_1_ink),
        .is_quantized             = true,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_1_ink,
    },
    [GGML_TYPE_Q4_1_ink] = {
        .type_name                = "q4_1_ink",
        .blck_size                = QK4_1_ink,
        .type_size                = sizeof(block_q4_1_ink),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_1_ink,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_1_ink_ref,
    },
    [GGML_TYPE_Q8_1_ink_fp32] = { // GGML_TYPE_IQ4_NL_8_8
        .type_name                = "q8_1_ink_fp32",
        .blck_size                = QK8_1_ink,
        .type_size                = sizeof(block_q8_1_ink_fp32),
        .is_quantized             = true,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_1_ink_fp32,
    },
    [GGML_TYPE_Q4_1_ink_fp32] = {
        .type_name                = "q4_1_ink_fp32",
        .blck_size                = QK4_1_ink,
        .type_size                = sizeof(block_q4_1_ink_fp32),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_1_ink_fp32,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_1_ink_fp32_ref,
    },
    [GGML_TYPE_Q8_0_ink] = {
        .type_name                = "q8_0_ink",
        .blck_size                = QK8_0_ink,
        .type_size                = sizeof(block_q8_0_ink),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_ink,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_0_ink_ref,
    },
    [GGML_TYPE_Q4_0_ink] = {
        .type_name                = "q4_0_ink",
        .blck_size                = QK4_0_ink,
        .type_size                = sizeof(block_q4_0_ink),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_ink,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_ink_ref,
    },
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        // NOTE: Ink modified
        case GGML_TYPE_Q4_0_ink:    result = quantize_q4_0_ink(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_1_ink:    result = quantize_q4_1_ink(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_1_ink_fp32:    result = quantize_q4_1_ink_fp32(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_0_ink:    result = quantize_q8_0_ink(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_1_ink:    result = quantize_q8_1_ink(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_1_ink_fp32:    result = quantize_q8_1_ink_fp32(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
