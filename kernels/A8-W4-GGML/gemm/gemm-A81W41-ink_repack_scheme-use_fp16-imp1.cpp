...
)
{
    ...
    for (int i = 0; i < nb_m; i += 6)
    {
        ...
        struct q8_repack_1x2_fp16 * A_ptr = A_ptr_start + i * nb_k;
        struct q8_repack_1x2_fp16 * A_ptr_next = A_ptr_start + (i + 1) * nb_k;
        struct q8_repack_1x2_fp16 * A_ptr_next2 = A_ptr_start + (i + 2) * nb_k;
        struct q8_repack_1x2_fp16 * A_ptr_next3 = A_ptr_start + (i + 3) * nb_k;
        struct q8_repack_1x2_fp16 * A_ptr_next4 = A_ptr_start + (i + 4) * nb_k;
        struct q8_repack_1x2_fp16 * A_ptr_next5 = A_ptr_start + (i + 5) * nb_k;
