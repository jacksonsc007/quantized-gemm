...
int main() {
    ...
    printf("\e[32m[ quantize weight tensor to int4]\e[m \n");
    ...
    // printf("\e[32m[ quantize activation to int8]\e[m \n");
    // struct ggml_tensor * q8_activation = ggml_new_tensor_2d(ctx, GGML_TYPE_Q8_0, K, M);
    // nelements = K * M;
    // ggml_quantize_chunk(
    //     GGML_TYPE_Q8_0, (const float *) activation->data, q8_activation->data, 0, nelements/q8_activation->ne[0], q8_activation->ne[0], nullptr
    // );


    // Set up a the compute graph
    printf("\e[32m[ Build graph ]\e[m \n");
