...
)
{
    ...
    __m256i perms[8] = {
        ...
        _mm256_setr_epi32(2, 2, 2, 2, 2, 2, 2, 2),
        _mm256_setr_epi32(3, 3, 3, 3, 3, 3, 3, 3),
        _mm256_setr_epi32(4, 4, 4, 4, 4, 4, 4, 4),
        _mm256_setr_epi32(5, 5, 5, 5, 5, 5, 5, 5),
        _mm256_setr_epi32(6, 6, 6, 6, 6, 6, 6, 6),
    ...
    for (int i = 0; i < nb_m; ++i)
    {
        for(int j = 0; j < nb_n; j++)
        {
            ...
            __m256 acc_row_0 = _mm256_setzero_ps();
            for (int blk_id = 0; blk_id < nb_k; blk_id++)
            {
                ...
                __m256i iacc_low_0 = _mm256_setzero_si256();
                __m256i iacc_high_0 = _mm256_setzero_si256();
                __m256i iacc_low_1 = _mm256_setzero_si256();
                __m256i iacc_high_1 = _mm256_setzero_si256();
                for (int pack_idx = 0; pack_idx < 8; pack_idx+=2)
                {
                    iacc_low_0 = mul_sum_i8_pairs_acc_int32x8(iacc_low_0, low_blk_A_packs[pack_idx], low_blk_B_packs[pack_idx]);
                    iacc_low_1 = mul_sum_i8_pairs_acc_int32x8(iacc_low_1, low_blk_A_packs[pack_idx + 1], low_blk_B_packs[pack_idx + 1]);
                    iacc_high_0 = mul_sum_i8_pairs_acc_int32x8(iacc_high_0, high_blk_A_packs[pack_idx], high_blk_B_packs[pack_idx]);
                    iacc_high_1 = mul_sum_i8_pairs_acc_int32x8(iacc_high_1, high_blk_A_packs[pack_idx + 1], high_blk_B_packs[pack_idx + 1]);
                }
                __m256i iacc_low = _mm256_add_epi32(iacc_low_0, iacc_low_1);
                __m256i iacc_high = _mm256_add_epi32(iacc_high_0, iacc_high_1);
                ...
                acc_row_0 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_low), s_low, acc_row_0);
                acc_row_0 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(iacc_high), s_high, acc_row_0);
            }
            _mm256_storeu_ps(C(i, j * 8, N), acc_row_0);
        }
    }
}
