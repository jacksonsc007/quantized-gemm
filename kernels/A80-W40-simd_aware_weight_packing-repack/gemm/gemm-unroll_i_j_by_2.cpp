    ...
    for (int i = 0; i < nb_m; i += 2)
    {
        for(int j = 0; j < nb_n; j += 2)
        {
            ...
            for (int blk_id = 0; blk_id < nb_k; blk_id++)
            {
                ...
                // Process scaling for first row, first column
                ...
                // Process scaling for first row, second column
                ...
                // Process scaling for second row, first column
                ...
                // Process scaling for second row, second column
