    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
        ...
        for (int p = 0; p < block_k; p += Q_BLK_SIZE)
        {
            ...
            float sB_j0 = *blockSB(block_idx, 0, block_k/Q_BLK_SIZE);
            float sB_j1 = *blockSB(block_idx, 0+1, block_k/Q_BLK_SIZE);
            ...
            __m256i b_pack_int8_j0 = bytes_from_nibbles_32(blockB(p/2, 0, block_k/2));
            __m256i b_pack_int8_j1 = bytes_from_nibbles_32(blockB(p/2, 0+1, block_k/2));
            ...
            {
                case 3:
                    *C(0, 0, NDIM) += hsum_float_8(sum_packed_fp_0_j0);
                    *C(1, 0, NDIM) += hsum_float_8(sum_packed_fp_1_j0);
                    *C(2, 0, NDIM) += hsum_float_8(sum_packed_fp_2_j0);
                    *C(0, 0+1, NDIM) += hsum_float_8(sum_packed_fp_0_j1);
                    *C(1, 0+1, NDIM) += hsum_float_8(sum_packed_fp_1_j1);
                    *C(2, 0+1, NDIM) += hsum_float_8(sum_packed_fp_2_j1);
                    break;
                case 2:
                    *C(0, 0, NDIM) += hsum_float_8(sum_packed_fp_0_j0);
                    *C(1, 0, NDIM) += hsum_float_8(sum_packed_fp_1_j0);
