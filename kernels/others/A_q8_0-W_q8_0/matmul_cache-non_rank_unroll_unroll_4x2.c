    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
        ...
        for (int p = 0; p < block_k; p += Q_BLK_SIZE)
        {
            ...
            float sA3 = *blockSA(3, p / Q_BLK_SIZE, block_k/Q_BLK_SIZE);
            float sB0 = *blockSB(p / Q_BLK_SIZE, 0, block_k/Q_BLK_SIZE);
            float sB1 = *blockSB(p / Q_BLK_SIZE, 0+1, block_k/Q_BLK_SIZE);
            
            __m256 fused_s0_v0 = _mm256_set1_ps(sA0 * sB0);
            __m256 fused_s1_v0 = _mm256_set1_ps(sA1 * sB0);
            __m256 fused_s2_v0 = _mm256_set1_ps(sA2 * sB0);
            __m256 fused_s3_v0 = _mm256_set1_ps(sA3 * sB0);
            __m256 fused_s0_v1 = _mm256_set1_ps(sA0 * sB1);
            __m256 fused_s1_v1 = _mm256_set1_ps(sA1 * sB1);
            __m256 fused_s2_v1 = _mm256_set1_ps(sA2 * sB1);
            __m256 fused_s3_v1 = _mm256_set1_ps(sA3 * sB1);
            ...
            __m256i a_pack_int8_3 = _mm256_loadu_si256((__m256i *) blockA(3, p, block_k));
            __m256i b_pack_int8_0 = _mm256_loadu_si256((__m256i *) blockB(p, 0, block_k));
            __m256i b_pack_int8_1 = _mm256_loadu_si256((__m256i *) blockB(p, 0+1, block_k));
            ...
            __m256i a_pack_int8_abs_3 = _mm256_sign_epi8(a_pack_int8_3, a_pack_int8_3);
            
            __m256i b_pack_int8_00 = _mm256_sign_epi8(b_pack_int8_0, a_pack_int8_0);
            __m256i b_pack_int8_10 = _mm256_sign_epi8(b_pack_int8_1, a_pack_int8_0);
            __m256i b_pack_int8_01 = _mm256_sign_epi8(b_pack_int8_0, a_pack_int8_1);
            __m256i b_pack_int8_11 = _mm256_sign_epi8(b_pack_int8_1, a_pack_int8_1);
            __m256i b_pack_int8_02 = _mm256_sign_epi8(b_pack_int8_0, a_pack_int8_2);
            __m256i b_pack_int8_12 = _mm256_sign_epi8(b_pack_int8_1, a_pack_int8_2);
            __m256i b_pack_int8_03 = _mm256_sign_epi8(b_pack_int8_0, a_pack_int8_3);
            __m256i b_pack_int8_13 = _mm256_sign_epi8(b_pack_int8_1, a_pack_int8_3);
            
            __m256i sum_packed_00 = _mm256_maddubs_epi16(a_pack_int8_abs_0, b_pack_int8_00);
            __m256i sum_packed_10 = _mm256_maddubs_epi16(a_pack_int8_abs_0, b_pack_int8_10);
            __m256i sum_packed_01 = _mm256_maddubs_epi16(a_pack_int8_abs_1, b_pack_int8_01);
            __m256i sum_packed_11 = _mm256_maddubs_epi16(a_pack_int8_abs_1, b_pack_int8_11);
            __m256i sum_packed_02 = _mm256_maddubs_epi16(a_pack_int8_abs_2, b_pack_int8_02);
            __m256i sum_packed_12 = _mm256_maddubs_epi16(a_pack_int8_abs_2, b_pack_int8_12);
            __m256i sum_packed_03 = _mm256_maddubs_epi16(a_pack_int8_abs_3, b_pack_int8_03);
            __m256i sum_packed_13 = _mm256_maddubs_epi16(a_pack_int8_abs_3, b_pack_int8_13);
            
            sum_packed_00 = _mm256_madd_epi16(sum_packed_00, _mm256_set1_epi16(1));
            sum_packed_10 = _mm256_madd_epi16(sum_packed_10, _mm256_set1_epi16(1));
            sum_packed_01 = _mm256_madd_epi16(sum_packed_01, _mm256_set1_epi16(1));
            sum_packed_11 = _mm256_madd_epi16(sum_packed_11, _mm256_set1_epi16(1));
            sum_packed_02 = _mm256_madd_epi16(sum_packed_02, _mm256_set1_epi16(1));
            sum_packed_12 = _mm256_madd_epi16(sum_packed_12, _mm256_set1_epi16(1));
            sum_packed_03 = _mm256_madd_epi16(sum_packed_03, _mm256_set1_epi16(1));
            sum_packed_13 = _mm256_madd_epi16(sum_packed_13, _mm256_set1_epi16(1));
            
            __m256 tmp00 = _mm256_cvtepi32_ps(sum_packed_00);
            __m256 tmp10 = _mm256_cvtepi32_ps(sum_packed_10);
            __m256 tmp01 = _mm256_cvtepi32_ps(sum_packed_01);
            __m256 tmp11 = _mm256_cvtepi32_ps(sum_packed_11);
            __m256 tmp02 = _mm256_cvtepi32_ps(sum_packed_02);
            __m256 tmp12 = _mm256_cvtepi32_ps(sum_packed_12);
            __m256 tmp03 = _mm256_cvtepi32_ps(sum_packed_03);
            __m256 tmp13 = _mm256_cvtepi32_ps(sum_packed_13);
            
            sum_packed_fp_0_0 = _mm256_fmadd_ps(tmp00, fused_s0_v0, sum_packed_fp_0_0);
            sum_packed_fp_0_1 = _mm256_fmadd_ps(tmp10, fused_s0_v1, sum_packed_fp_0_1);
            sum_packed_fp_1_0 = _mm256_fmadd_ps(tmp01, fused_s1_v0, sum_packed_fp_1_0);
            sum_packed_fp_1_1 = _mm256_fmadd_ps(tmp11, fused_s1_v1, sum_packed_fp_1_1);
            sum_packed_fp_2_0 = _mm256_fmadd_ps(tmp02, fused_s2_v0, sum_packed_fp_2_0);
            sum_packed_fp_2_1 = _mm256_fmadd_ps(tmp12, fused_s2_v1, sum_packed_fp_2_1);
            sum_packed_fp_3_0 = _mm256_fmadd_ps(tmp03, fused_s3_v0, sum_packed_fp_3_0);
            sum_packed_fp_3_1 = _mm256_fmadd_ps(tmp13, fused_s3_v1, sum_packed_fp_3_1);
        }
        ...
        switch(block_m)
        {
            case 4:
                // First column (j)
                tmp0 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_0_0, 1), _mm256_extractf128_ps(sum_packed_fp_0_0, 0));
                tmp0 = _mm_add_ps(tmp0, _mm_movehl_ps(tmp0, tmp0));
                tmp0 = _mm_add_ss(tmp0, _mm_movehdup_ps(tmp0));
                *C(0, 0, NDIM) += _mm_cvtss_f32(tmp0);
                
                tmp1 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_1_0, 1), _mm256_extractf128_ps(sum_packed_fp_1_0, 0));
                tmp1 = _mm_add_ps(tmp1, _mm_movehl_ps(tmp1, tmp1));
                tmp1 = _mm_add_ss(tmp1, _mm_movehdup_ps(tmp1));
                *C(1, 0, NDIM) += _mm_cvtss_f32(tmp1);
                
                tmp2 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_2_0, 1), _mm256_extractf128_ps(sum_packed_fp_2_0, 0));
                tmp2 = _mm_add_ps(tmp2, _mm_movehl_ps(tmp2, tmp2));
                tmp2 = _mm_add_ss(tmp2, _mm_movehdup_ps(tmp2));
                *C(2, 0, NDIM) += _mm_cvtss_f32(tmp2);
                
                tmp3 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_3_0, 1), _mm256_extractf128_ps(sum_packed_fp_3_0, 0));
                tmp3 = _mm_add_ps(tmp3, _mm_movehl_ps(tmp3, tmp3));
                tmp3 = _mm_add_ss(tmp3, _mm_movehdup_ps(tmp3));
                *C(3, 0, NDIM) += _mm_cvtss_f32(tmp3);
                // Second column (0+1)
                tmp0 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_0_1, 1), _mm256_extractf128_ps(sum_packed_fp_0_1, 0));
                tmp0 = _mm_add_ps(tmp0, _mm_movehl_ps(tmp0, tmp0));
                tmp0 = _mm_add_ss(tmp0, _mm_movehdup_ps(tmp0));
                *C(0, 0+1, NDIM) += _mm_cvtss_f32(tmp0);
                
                tmp1 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_1_1, 1), _mm256_extractf128_ps(sum_packed_fp_1_1, 0));
                tmp1 = _mm_add_ps(tmp1, _mm_movehl_ps(tmp1, tmp1));
                tmp1 = _mm_add_ss(tmp1, _mm_movehdup_ps(tmp1));
                *C(1, 0+1, NDIM) += _mm_cvtss_f32(tmp1);
                
                tmp2 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_2_1, 1), _mm256_extractf128_ps(sum_packed_fp_2_1, 0));
                tmp2 = _mm_add_ps(tmp2, _mm_movehl_ps(tmp2, tmp2));
                tmp2 = _mm_add_ss(tmp2, _mm_movehdup_ps(tmp2));
                *C(2, 0+1, NDIM) += _mm_cvtss_f32(tmp2);
                tmp3 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_3_1, 1), _mm256_extractf128_ps(sum_packed_fp_3_1, 0));
                tmp3 = _mm_add_ps(tmp3, _mm_movehl_ps(tmp3, tmp3));
                tmp3 = _mm_add_ss(tmp3, _mm_movehdup_ps(tmp3));
                *C(3, 0+1, NDIM) += _mm_cvtss_f32(tmp3);
                break;
            case 3:
                // First column (j)
                tmp0 = _mm_add_ps(_mm256_extractf128_ps(sum_packed_fp_0_0, 1), _mm256_extractf128_ps(sum_packed_fp_0_0, 0));
