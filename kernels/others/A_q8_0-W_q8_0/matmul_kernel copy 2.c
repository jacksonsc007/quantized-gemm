    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
    for (int j = 0; j < block_n; ++j)
    {
        ...
        for (int p = 0; p < block_k; p += Q_BLK_SIZE)
        {
            ...
            // _mm_prefetch((char *)(blockA + p + Q_BLK_SIZE), _MM_HINT_T0);
            ...
            __m256i a_pack_int8_abs_0 = _mm256_abs_epi8(a_pack_int8_0);
            __m256i a_pack_int8_abs_1 = _mm256_abs_epi8(a_pack_int8_1);
            __m256i a_pack_int8_abs_2 = _mm256_abs_epi8(a_pack_int8_2);
            
            __m256i sum_packed_0 = _mm256_maddubs_epi16(a_pack_int8_abs_0, b_pack_int8);
            __m256i sum_packed_1 = _mm256_maddubs_epi16(a_pack_int8_abs_1, b_pack_int8);
            __m256i sum_packed_2 = _mm256_maddubs_epi16(a_pack_int8_abs_2, b_pack_int8);
            ...
            sum_packed_fp_0 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(sum_packed_0), fused_s0_v, sum_packed_fp_0);
            sum_packed_fp_1 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(sum_packed_1), fused_s1_v, sum_packed_fp_1);
            sum_packed_fp_2 = _mm256_fmadd_ps(_mm256_cvtepi32_ps(sum_packed_2), fused_s2_v, sum_packed_fp_2);
        }
