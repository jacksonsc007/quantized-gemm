    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
        ...
        for (int p = 0; p < block_k; p += Q_BLK_SIZE)
        {
            ...
            __m256 tmp00 = mul_sum_i8_pairs_float(a_pack_int8_0, b_pack_int8_0);
            __m256 tmp10 = mul_sum_i8_pairs_float(a_pack_int8_1, b_pack_int8_0);
            __m256 tmp20 = mul_sum_i8_pairs_float(a_pack_int8_2, b_pack_int8_0);

            __m256 tmp01 = mul_sum_i8_pairs_float(a_pack_int8_0, b_pack_int8_1);
            __m256 tmp11 = mul_sum_i8_pairs_float(a_pack_int8_1, b_pack_int8_1);
            __m256 tmp21 = mul_sum_i8_pairs_float(a_pack_int8_2, b_pack_int8_1);
            ...
            sum_packed_fp_0_1 += tmp01 * fused_s0_v1;
            sum_packed_fp_1_0 += tmp10 * fused_s1_v0;
            sum_packed_fp_1_1 += tmp11 * fused_s1_v1;
            sum_packed_fp_2_0 += tmp20 * fused_s2_v0;
            sum_packed_fp_2_1 += tmp21 * fused_s2_v1;
        }
