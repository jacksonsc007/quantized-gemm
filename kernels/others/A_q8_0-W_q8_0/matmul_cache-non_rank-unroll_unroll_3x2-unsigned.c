...
void kernel( int8_t * blockA, int8_t * blockB, float * blockSA, float * blockSB, float* C, const int block_m, const int block_n, const int block_k) { 
            ...
            for (int p = 0; p < block_k; p += Q_BLK_SIZE) { 
                ...
                __m256i sum_packed_00 = _mm256_maddubs_epi16(a_pack_int8_0, b_pack_int8_0); 
                __m256i sum_packed_10 = _mm256_maddubs_epi16(a_pack_int8_0, b_pack_int8_1); 
                __m256i sum_packed_01 = _mm256_maddubs_epi16(a_pack_int8_1, b_pack_int8_0); 
                __m256i sum_packed_11 = _mm256_maddubs_epi16(a_pack_int8_1, b_pack_int8_1); 
                __m256i sum_packed_02 = _mm256_maddubs_epi16(a_pack_int8_2, b_pack_int8_0); 
                __m256i sum_packed_12 = _mm256_maddubs_epi16(a_pack_int8_2, b_pack_int8_1);
