    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
        ...
        for (int p = 0; p < block_k; p += Q_BLK_SIZE)
        {
            ...
            // sum_packed_fp_0_0 += tmp00 * fused_s0_v0;
            // sum_packed_fp_0_1 += tmp10 * fused_s0_v1;
            // sum_packed_fp_1_0 += tmp01 * fused_s1_v0;
            // sum_packed_fp_1_1 += tmp11 * fused_s1_v1;
            // sum_packed_fp_2_0 += tmp02 * fused_s2_v0;
            // sum_packed_fp_2_1 += tmp12 * fused_s2_v1;
        }
