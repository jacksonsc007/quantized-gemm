    ...
    const int M, const int N, const int K) 
{
    for (int j = 0; j < N - 3; j += 4)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            __m256 tmp_0_2 = mul_sum_us8_pairs_float(b_pack_int8_low_2, a_pack_int8_low);
            __m256 tmp_0_3 = mul_sum_us8_pairs_float(b_pack_int8_low_3, a_pack_int8_low);
            ...
            __m256 tmp_1_2 = mul_sum_us8_pairs_float(b_pack_int8_high_2, a_pack_int8_high);
            __m256 tmp_1_3 = mul_sum_us8_pairs_float(b_pack_int8_high_3, a_pack_int8_high);
            ...
            extra_sum_fp_2 += sum_a_0_fused * min_b_0_2;
            extra_sum_fp_2 += sum_a_1_fused * min_b_1_2;
            extra_sum_fp_3 += sum_a_0_fused * min_b_0_3;
            extra_sum_fp_3 += sum_a_1_fused * min_b_1_3;
        }
        *C(0, j, NDIM) += hsum_float_8(sum_packed_fp_0) + extra_sum_fp_0;
        *C(0, j+1, NDIM) += hsum_float_8(sum_packed_fp_1) + extra_sum_fp_1;
        *C(0, j+2, NDIM) += hsum_float_8(sum_packed_fp_2) + extra_sum_fp_2;
        *C(0, j+3, NDIM) += hsum_float_8(sum_packed_fp_3) + extra_sum_fp_3;
    }
    ...
    for (int j = N - (N % 4); j < N; j++) {
        ...
        *C(0, j, NDIM) += hsum_float_8(sum_packed_fp) + extra_sum_fp;
    }
}
