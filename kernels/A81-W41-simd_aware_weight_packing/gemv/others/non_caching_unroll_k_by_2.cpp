    ...
    const int M, const int N, const int K) 
{
    for (int j = 0; j < N; j++)
    {
        ...
        for (int p = 0; p < K; p += 4 * Q_BLK_SIZE)
        {
            ...
            extra_sum_fp_0 += sum_a_0_0_fused * min_b_0_0;
            extra_sum_fp_0 += sum_a_0_1_fused * min_b_0_1;
            ...
            extra_sum_fp_1 += sum_a_1_0_fused * min_b_1_0;
            extra_sum_fp_1 += sum_a_1_1_fused * min_b_1_1;
        }
        *C(0, j, NDIM) += hsum_float_8(sum_packed_fp_0) + hsum_float_8(sum_packed_fp_1) + extra_sum_fp_0 + extra_sum_fp_1;
    }
}
