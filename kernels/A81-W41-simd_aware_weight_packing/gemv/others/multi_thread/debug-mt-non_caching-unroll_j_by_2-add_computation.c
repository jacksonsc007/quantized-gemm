    ...
    const int M, const int N, const int K) 
{
    ...
    for (int j = 0; j < N - 1; j += 2)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            volatile __m256 tmp_1_j2 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high);
            volatile __m256 tmp_1_j3 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high);
