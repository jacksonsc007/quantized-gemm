...
{
    // Process two columns at once to improve memory reuse
    for (int j = 0; j < N - 1; j += 2)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            // Load scale factors for both columns at once
            ...
            // Compute fused scales for both columns
            ...
            // Load min values and scaled sums for both columns
            ...
            // Load A values once for both columns
            ...
            // Load B values for both columns
            ...
            // Extract low and high parts for both columns
            ...
            // Compute products and accumulate for both columns
