    ...
    const int M, const int N, const int K) 
{
    for (int j = 0; j < N; j += 2)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            // j
            float sA_0_0 = *SA(0, block_idx, K/Q_BLK_SIZE);
            float sB_0_0 = *SB(block_idx, j, K/Q_BLK_SIZE);
            float sA_1_0 = *SA(0, block_idx + 1, K/Q_BLK_SIZE);
            ...
            float sum_a_0_fused_0 = *ScaledSumA(0, block_idx, K / Q_BLK_SIZE);
            float sum_a_1_fused_0 = *ScaledSumA(0, block_idx + 1, K / Q_BLK_SIZE);
            ...
            __m256 tmp_1_0 = mul_sum_us8_pairs_float(b_pack_int8_high_0, a_pack_int8_high_0);
            sum_packed_fp_0_0 = _mm256_fmadd_ps(tmp_0_0, _mm256_set1_ps(fused_s_0_0), sum_packed_fp_0_0);
            sum_packed_fp_1_0 = _mm256_fmadd_ps(tmp_1_0, _mm256_set1_ps(fused_s_1_0), sum_packed_fp_1_0);

            extra_sum_fp_0_0 += sum_a_0_fused_0 * min_b_0_0;
            extra_sum_fp_1_0 += sum_a_1_fused_0 * min_b_1_0;

            // j+1
                float sA_0_1 = *SA(0, block_idx, K/Q_BLK_SIZE);
                float sB_0_1 = *SB(block_idx, j + 1, K/Q_BLK_SIZE);
                float sA_1_1 = *SA(0, block_idx + 1, K/Q_BLK_SIZE);
                ...
                float sum_a_0_fused_1 = *ScaledSumA(0, block_idx, K / Q_BLK_SIZE);
                float sum_a_1_fused_1 = *ScaledSumA(0, block_idx + 1, K / Q_BLK_SIZE);

                __m256i a_pack_int8_low_1 = a_pack_int8_low_0;
                __m256i a_pack_int8_high_1 = a_pack_int8_high_0;
                ...
                __m256 tmp_0_1 = mul_sum_us8_pairs_float(b_pack_int8_low_1, a_pack_int8_low_1);
                __m256 tmp_1_1 = mul_sum_us8_pairs_float(b_pack_int8_high_1, a_pack_int8_high_1);
                sum_packed_fp_0_1 = _mm256_fmadd_ps(tmp_0_1, _mm256_set1_ps(fused_s_0_1), sum_packed_fp_0_1);
                sum_packed_fp_1_1 = _mm256_fmadd_ps(tmp_1_1, _mm256_set1_ps(fused_s_1_1), sum_packed_fp_1_1);

                extra_sum_fp_0_1 += sum_a_0_fused_1 * min_b_0_1;
                extra_sum_fp_1_1 += sum_a_1_fused_1 * min_b_1_1;
        }
        *C(0, j, NDIM)     += hsum_float_8(sum_packed_fp_0_0) + extra_sum_fp_0_0;
        *C(0, j, NDIM)     += hsum_float_8(sum_packed_fp_1_0) + extra_sum_fp_1_0;
            *C(0, j + 1, NDIM) += hsum_float_8(sum_packed_fp_0_1) + extra_sum_fp_0_1;
            *C(0, j + 1, NDIM) += hsum_float_8(sum_packed_fp_1_1) + extra_sum_fp_1_1;
    }
}
