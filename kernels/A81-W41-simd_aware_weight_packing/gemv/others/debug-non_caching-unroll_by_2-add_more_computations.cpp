    ...
    const int M, const int N, const int K) 
{
    for (int j = 0; j < N - 1; j += 2)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            float sB_0_0 = *SB(block_idx, j, K/Q_BLK_SIZE);
            float sB_0_1 = *SB(block_idx, j+1, K/Q_BLK_SIZE);
            float sA_1 = *SA(0, block_idx + 1, K/Q_BLK_SIZE);
            float sB_1_0 = *SB(block_idx + 1, j, K/Q_BLK_SIZE);
            float sB_1_1 = *SB(block_idx + 1, j+1, K/Q_BLK_SIZE);
            
            float fused_s_0_0 = sA_0 * sB_0_0;
            float fused_s_0_1 = sA_0 * sB_0_1;
            float fused_s_1_0 = sA_1 * sB_1_0;
            float fused_s_1_1 = sA_1 * sB_1_1;
            
            float min_b_0_0 = *MinB(block_idx, j, K / Q_BLK_SIZE);
            float min_b_0_1 = *MinB(block_idx, j+1, K / Q_BLK_SIZE);
            float min_b_1_0 = *MinB(block_idx + 1, j, K / Q_BLK_SIZE);
            float min_b_1_1 = *MinB(block_idx + 1, j+1, K / Q_BLK_SIZE);
            ...
            __m256i b_pack_int8_1 = _mm256_loadu_si256( (__m256i *) B(p/2, j+1, K/2));
            ...
            __m256 tmp_0_0 = mul_sum_us8_pairs_float( b_pack_int8_low_0  ,a_pack_int8_low );
            __m256 tmp_0_1 = mul_sum_us8_pairs_float( b_pack_int8_low_1  ,a_pack_int8_low );
            __m256 tmp_1_0 = mul_sum_us8_pairs_float( b_pack_int8_high_0 ,a_pack_int8_high);
            __m256 tmp_1_1 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_1 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_2 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_3 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_4 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_5 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_6 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_7 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_8 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_9 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_10 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_11 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_12 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_13 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_14 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_15 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_16 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_17 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_18 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_19 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_20 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_21 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_22 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_23 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            volatile __m256 tmp_24 = mul_sum_us8_pairs_float( b_pack_int8_high_1 ,a_pack_int8_high);
            ...
            extra_sum_fp_0 += sum_a_0_fused * min_b_0_0;
            extra_sum_fp_0 += sum_a_1_fused * min_b_1_0;
            extra_sum_fp_1 += sum_a_0_fused * min_b_0_1;
            extra_sum_fp_1 += sum_a_1_fused * min_b_1_1;
        }
        *C(0, j, NDIM) += hsum_float_8(sum_packed_fp_0) + extra_sum_fp_0;
        *C(0, j+1, NDIM) += hsum_float_8(sum_packed_fp_1) + extra_sum_fp_1;
    }
