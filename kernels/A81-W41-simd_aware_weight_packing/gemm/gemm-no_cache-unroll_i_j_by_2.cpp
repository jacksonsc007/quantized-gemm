    ...
    const int M, const int N, const int K) 
{
    ...
    for (int j = 0; j < N; j += 2)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            float fused_s_00_1 = sA_0_1 * sB_1_0;
            float fused_s_01_0 = sA_0_0 * sB_0_1;
            float fused_s_01_1 = sA_0_1 * sB_1_1;
            float fused_s_10_0 = sA_1_0 * sB_0_0;
            float fused_s_10_1 = sA_1_1 * sB_1_0;
            float fused_s_11_0 = sA_1_0 * sB_0_1;
            ...
            __m256 tmp_00_0 = mul_sum_us8_pairs_float(b_pack_int8_low_0, a_pack_int8_low_0);
            __m256 tmp_00_1 = mul_sum_us8_pairs_float(b_pack_int8_high_0, a_pack_int8_high_0);
            __m256 tmp_01_0 = mul_sum_us8_pairs_float(b_pack_int8_low_1, a_pack_int8_low_0);
            __m256 tmp_01_1 = mul_sum_us8_pairs_float(b_pack_int8_high_1, a_pack_int8_high_0);
            __m256 tmp_10_0 = mul_sum_us8_pairs_float(b_pack_int8_low_0, a_pack_int8_low_1);
            __m256 tmp_10_1 = mul_sum_us8_pairs_float(b_pack_int8_high_0, a_pack_int8_high_1);
            __m256 tmp_11_0 = mul_sum_us8_pairs_float(b_pack_int8_low_1, a_pack_int8_low_1);
            __m256 tmp_11_1 = mul_sum_us8_pairs_float(b_pack_int8_high_1, a_pack_int8_high_1);
            ...
            extra_sum_fp_00 += sum_a_0_0_fused * min_b_0_0 + sum_a_0_1_fused * min_b_1_0;
            extra_sum_fp_01 += sum_a_0_0_fused * min_b_0_1 + sum_a_0_1_fused * min_b_1_1;
            extra_sum_fp_10 += sum_a_1_0_fused * min_b_0_0 + sum_a_1_1_fused * min_b_1_0;
            extra_sum_fp_11 += sum_a_1_0_fused * min_b_0_1 + sum_a_1_1_fused * min_b_1_1;
        }
