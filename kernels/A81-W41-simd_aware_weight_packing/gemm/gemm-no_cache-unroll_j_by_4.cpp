    ...
    const int M, const int N, const int K) 
{
    ...
    for (int j = 0; j < N - 3; j += 4)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            float sB_0_2 = *SB(block_idx, j + 2, K/Q_BLK_SIZE);
            float sB_0_3 = *SB(block_idx, j + 3, K/Q_BLK_SIZE);
            ...
            float sB_1_2 = *SB(block_idx + 1, j + 2, K/Q_BLK_SIZE);
            float sB_1_3 = *SB(block_idx + 1, j + 3, K/Q_BLK_SIZE);
            float fused_s_0_0 = sA_0 * sB_0_0;
            float fused_s_0_1 = sA_0 * sB_0_1;
            float fused_s_0_2 = sA_0 * sB_0_2;
            float fused_s_0_3 = sA_0 * sB_0_3;
            float fused_s_1_0 = sA_1 * sB_1_0;
            float fused_s_1_1 = sA_1 * sB_1_1;
            float fused_s_1_2 = sA_1 * sB_1_2;
            float fused_s_1_3 = sA_1 * sB_1_3;
            
            float min_b_0_0 = *MinB(block_idx, j, K / Q_BLK_SIZE);
            float min_b_0_1 = *MinB(block_idx, j + 1, K / Q_BLK_SIZE);
            float min_b_0_2 = *MinB(block_idx, j + 2, K / Q_BLK_SIZE);
            float min_b_0_3 = *MinB(block_idx, j + 3, K / Q_BLK_SIZE);
            float min_b_1_0 = *MinB(block_idx + 1, j, K / Q_BLK_SIZE);
            float min_b_1_1 = *MinB(block_idx + 1, j + 1, K / Q_BLK_SIZE);
            float min_b_1_2 = *MinB(block_idx + 1, j + 2, K / Q_BLK_SIZE);
            float min_b_1_3 = *MinB(block_idx + 1, j + 3, K / Q_BLK_SIZE);
            ...
            __m256i b_pack_int8_2 = _mm256_loadu_si256( (__m256i *) B(p/2, j + 2, K/2));
            __m256i b_pack_int8_3 = _mm256_loadu_si256( (__m256i *) B(p/2, j + 3, K/2));
            ...
            __m256 tmp_0_1 = mul_sum_us8_pairs_float(b_pack_int8_high_0, a_pack_int8_high);
            __m256 tmp_1_0 = mul_sum_us8_pairs_float(b_pack_int8_low_1, a_pack_int8_low);
            __m256 tmp_1_1 = mul_sum_us8_pairs_float(b_pack_int8_high_1, a_pack_int8_high);
            __m256 tmp_2_0 = mul_sum_us8_pairs_float(b_pack_int8_low_2, a_pack_int8_low);
            __m256 tmp_2_1 = mul_sum_us8_pairs_float(b_pack_int8_high_2, a_pack_int8_high);
            __m256 tmp_3_0 = mul_sum_us8_pairs_float(b_pack_int8_low_3, a_pack_int8_low);
            __m256 tmp_3_1 = mul_sum_us8_pairs_float(b_pack_int8_high_3, a_pack_int8_high);

            sum_packed_fp_0 = _mm256_fmadd_ps(tmp_0_0, _mm256_set1_ps(fused_s_0_0), sum_packed_fp_0);
            sum_packed_fp_0 = _mm256_fmadd_ps(tmp_0_1, _mm256_set1_ps(fused_s_1_0), sum_packed_fp_0);
            sum_packed_fp_1 = _mm256_fmadd_ps(tmp_1_0, _mm256_set1_ps(fused_s_0_1), sum_packed_fp_1);
            sum_packed_fp_1 = _mm256_fmadd_ps(tmp_1_1, _mm256_set1_ps(fused_s_1_1), sum_packed_fp_1);
            sum_packed_fp_2 = _mm256_fmadd_ps(tmp_2_0, _mm256_set1_ps(fused_s_0_2), sum_packed_fp_2);
            sum_packed_fp_2 = _mm256_fmadd_ps(tmp_2_1, _mm256_set1_ps(fused_s_1_2), sum_packed_fp_2);
            sum_packed_fp_3 = _mm256_fmadd_ps(tmp_3_0, _mm256_set1_ps(fused_s_0_3), sum_packed_fp_3);
            sum_packed_fp_3 = _mm256_fmadd_ps(tmp_3_1, _mm256_set1_ps(fused_s_1_3), sum_packed_fp_3);

            extra_sum_fp_0 += sum_a_0_fused * min_b_0_0 + sum_a_1_fused * min_b_1_0;
            extra_sum_fp_1 += sum_a_0_fused * min_b_0_1 + sum_a_1_fused * min_b_1_1;
            extra_sum_fp_2 += sum_a_0_fused * min_b_0_2 + sum_a_1_fused * min_b_1_2;
            extra_sum_fp_3 += sum_a_0_fused * min_b_0_3 + sum_a_1_fused * min_b_1_3;
        }
        *C(i, j, NDIM) += hsum_float_8(sum_packed_fp_0) + extra_sum_fp_0;
        *C(i, j + 1, NDIM) += hsum_float_8(sum_packed_fp_1) + extra_sum_fp_1;
        *C(i, j + 2, NDIM) += hsum_float_8(sum_packed_fp_2) + extra_sum_fp_2;
        *C(i, j + 3, NDIM) += hsum_float_8(sum_packed_fp_3) + extra_sum_fp_3;
    }
}
