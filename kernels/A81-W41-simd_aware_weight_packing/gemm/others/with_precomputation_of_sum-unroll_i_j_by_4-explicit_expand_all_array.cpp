    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
    ...
    for (int j = 0; j < block_n; j += 4)
    {
        ...
        float extra_sum_fp_02 = 0;
        float extra_sum_fp_03 = 0;
        float extra_sum_fp_10 = 0;
        float extra_sum_fp_11 = 0;
        float extra_sum_fp_12 = 0;
        float extra_sum_fp_13 = 0;
        float extra_sum_fp_20 = 0;
        float extra_sum_fp_21 = 0;
        float extra_sum_fp_22 = 0;
        float extra_sum_fp_23 = 0;
        float extra_sum_fp_30 = 0;
        float extra_sum_fp_31 = 0;
        float extra_sum_fp_32 = 0;
        float extra_sum_fp_33 = 0;

        for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
        {
            int block_idx = p / Q_BLK_SIZE;
            
            // Load scale factors for A (4 rows)
            float sA_0_0 = *blockSA(i+0, block_idx, block_k/Q_BLK_SIZE);
            float sA_0_1 = *blockSA(i+0, block_idx + 1, block_k/Q_BLK_SIZE);
            float sA_1_0 = *blockSA(i+1, block_idx, block_k/Q_BLK_SIZE);
            float sA_1_1 = *blockSA(i+1, block_idx + 1, block_k/Q_BLK_SIZE);
            float sA_2_0 = *blockSA(i+2, block_idx, block_k/Q_BLK_SIZE);
            float sA_2_1 = *blockSA(i+2, block_idx + 1, block_k/Q_BLK_SIZE);
            float sA_3_0 = *blockSA(i+3, block_idx, block_k/Q_BLK_SIZE);
            float sA_3_1 = *blockSA(i+3, block_idx + 1, block_k/Q_BLK_SIZE);

            // Load scale factors for B (4 columns)
            float sB_0_0 = *blockSB(block_idx, j+0, block_k/Q_BLK_SIZE);
            float sB_0_1 = *blockSB(block_idx + 1, j+0, block_k/Q_BLK_SIZE);
            float sB_1_0 = *blockSB(block_idx, j+1, block_k/Q_BLK_SIZE);
            float sB_1_1 = *blockSB(block_idx + 1, j+1, block_k/Q_BLK_SIZE);
            float sB_2_0 = *blockSB(block_idx, j+2, block_k/Q_BLK_SIZE);
            float sB_2_1 = *blockSB(block_idx + 1, j+2, block_k/Q_BLK_SIZE);
            float sB_3_0 = *blockSB(block_idx, j+3, block_k/Q_BLK_SIZE);
            float sB_3_1 = *blockSB(block_idx + 1, j+3, block_k/Q_BLK_SIZE);

            // Fused scale factors (4x4)
            float fused_s_00_0 = sA_0_0 * sB_0_0;
            float fused_s_00_1 = sA_0_1 * sB_0_1;
            float fused_s_01_0 = sA_0_0 * sB_1_0;
            float fused_s_01_1 = sA_0_1 * sB_1_1;
            float fused_s_02_0 = sA_0_0 * sB_2_0;
            float fused_s_02_1 = sA_0_1 * sB_2_1;
            float fused_s_03_0 = sA_0_0 * sB_3_0;
            float fused_s_03_1 = sA_0_1 * sB_3_1;
            
            float fused_s_10_0 = sA_1_0 * sB_0_0;
            float fused_s_10_1 = sA_1_1 * sB_0_1;
            float fused_s_11_0 = sA_1_0 * sB_1_0;
            float fused_s_11_1 = sA_1_1 * sB_1_1;
            float fused_s_12_0 = sA_1_0 * sB_2_0;
            float fused_s_12_1 = sA_1_1 * sB_2_1;
            float fused_s_13_0 = sA_1_0 * sB_3_0;
            float fused_s_13_1 = sA_1_1 * sB_3_1;
            
            float fused_s_20_0 = sA_2_0 * sB_0_0;
            float fused_s_20_1 = sA_2_1 * sB_0_1;
            float fused_s_21_0 = sA_2_0 * sB_1_0;
            float fused_s_21_1 = sA_2_1 * sB_1_1;
            float fused_s_22_0 = sA_2_0 * sB_2_0;
            float fused_s_22_1 = sA_2_1 * sB_2_1;
            float fused_s_23_0 = sA_2_0 * sB_3_0;
            float fused_s_23_1 = sA_2_1 * sB_3_1;
            
            float fused_s_30_0 = sA_3_0 * sB_0_0;
            float fused_s_30_1 = sA_3_1 * sB_0_1;
            float fused_s_31_0 = sA_3_0 * sB_1_0;
            float fused_s_31_1 = sA_3_1 * sB_1_1;
            float fused_s_32_0 = sA_3_0 * sB_2_0;
            float fused_s_32_1 = sA_3_1 * sB_2_1;
            float fused_s_33_0 = sA_3_0 * sB_3_0;
            float fused_s_33_1 = sA_3_1 * sB_3_1;

            // Load min values for B (4 columns)
            float min_b_0_0 = *blockMinB(block_idx, j+0, block_k / Q_BLK_SIZE);
            float min_b_0_1 = *blockMinB(block_idx + 1, j+0, block_k / Q_BLK_SIZE);
            float min_b_1_0 = *blockMinB(block_idx, j+1, block_k / Q_BLK_SIZE);
            float min_b_1_1 = *blockMinB(block_idx + 1, j+1, block_k / Q_BLK_SIZE);
            float min_b_2_0 = *blockMinB(block_idx, j+2, block_k / Q_BLK_SIZE);
            float min_b_2_1 = *blockMinB(block_idx + 1, j+2, block_k / Q_BLK_SIZE);
            float min_b_3_0 = *blockMinB(block_idx, j+3, block_k / Q_BLK_SIZE);
            float min_b_3_1 = *blockMinB(block_idx + 1, j+3, block_k / Q_BLK_SIZE);

            // Load scaled sums for A (4 rows)
            float sum_a_0_fused_0 = *blockScaledSumA(i+0, block_idx, block_k / Q_BLK_SIZE);
            float sum_a_0_fused_1 = *blockScaledSumA(i+0, block_idx + 1, block_k / Q_BLK_SIZE);
            float sum_a_1_fused_0 = *blockScaledSumA(i+1, block_idx, block_k / Q_BLK_SIZE);
            float sum_a_1_fused_1 = *blockScaledSumA(i+1, block_idx + 1, block_k / Q_BLK_SIZE);
            float sum_a_2_fused_0 = *blockScaledSumA(i+2, block_idx, block_k / Q_BLK_SIZE);
            float sum_a_2_fused_1 = *blockScaledSumA(i+2, block_idx + 1, block_k / Q_BLK_SIZE);
            float sum_a_3_fused_0 = *blockScaledSumA(i+3, block_idx, block_k / Q_BLK_SIZE);
            float sum_a_3_fused_1 = *blockScaledSumA(i+3, block_idx + 1, block_k / Q_BLK_SIZE);

            // Load A blocks (4 rows)
            ...
            // Load B data for both j iterations (packed)
            __m256i b_pack_int8_j0 = _mm256_loadu_si256((__m256i *) blockB(p/2, j, block_k/2));
            __m256i b_pack_int8_j1 = _mm256_loadu_si256((__m256i *) blockB(p/2, j+1, block_k/2));
            __m256i b_pack_int8_j2 = _mm256_loadu_si256((__m256i *) blockB(p/2, j+2, block_k/2));
            __m256i b_pack_int8_j3 = _mm256_loadu_si256((__m256i *) blockB(p/2, j+3, block_k/2));
            ...
            // Compute dot products for all 4x4 combinations
            __m256 tmp_00_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j0, a_pack_int8_low_0);
            __m256 tmp_00_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j0, a_pack_int8_high_0);
            sum_packed_fp_00 = _mm256_fmadd_ps(tmp_00_0, _mm256_set1_ps(fused_s_00_0), sum_packed_fp_00);
            sum_packed_fp_00 = _mm256_fmadd_ps(tmp_00_1, _mm256_set1_ps(fused_s_00_1), sum_packed_fp_00);
            extra_sum_fp_00 += sum_a_0_fused_0 * min_b_0_0;
            extra_sum_fp_00 += sum_a_0_fused_1 * min_b_0_1;

            __m256 tmp_01_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j1, a_pack_int8_low_0);
            __m256 tmp_01_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high_0);
            sum_packed_fp_01 = _mm256_fmadd_ps(tmp_01_0, _mm256_set1_ps(fused_s_01_0), sum_packed_fp_01);
            sum_packed_fp_01 = _mm256_fmadd_ps(tmp_01_1, _mm256_set1_ps(fused_s_01_1), sum_packed_fp_01);
            extra_sum_fp_01 += sum_a_0_fused_0 * min_b_1_0;
            extra_sum_fp_01 += sum_a_0_fused_1 * min_b_1_1;

            __m256 tmp_02_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j2, a_pack_int8_low_0);
            __m256 tmp_02_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j2, a_pack_int8_high_0);
            sum_packed_fp_02 = _mm256_fmadd_ps(tmp_02_0, _mm256_set1_ps(fused_s_02_0), sum_packed_fp_02);
            sum_packed_fp_02 = _mm256_fmadd_ps(tmp_02_1, _mm256_set1_ps(fused_s_02_1), sum_packed_fp_02);
            extra_sum_fp_02 += sum_a_0_fused_0 * min_b_2_0;
            extra_sum_fp_02 += sum_a_0_fused_1 * min_b_2_1;

            __m256 tmp_03_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j3, a_pack_int8_low_0);
            __m256 tmp_03_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j3, a_pack_int8_high_0);
            sum_packed_fp_03 = _mm256_fmadd_ps(tmp_03_0, _mm256_set1_ps(fused_s_03_0), sum_packed_fp_03);
            sum_packed_fp_03 = _mm256_fmadd_ps(tmp_03_1, _mm256_set1_ps(fused_s_03_1), sum_packed_fp_03);
            extra_sum_fp_03 += sum_a_0_fused_0 * min_b_3_0;
            extra_sum_fp_03 += sum_a_0_fused_1 * min_b_3_1;

            // Repeat for rows 1-3
            __m256 tmp_10_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j0, a_pack_int8_low_1);
            __m256 tmp_10_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j0, a_pack_int8_high_1);
            sum_packed_fp_10 = _mm256_fmadd_ps(tmp_10_0, _mm256_set1_ps(fused_s_10_0), sum_packed_fp_10);
            sum_packed_fp_10 = _mm256_fmadd_ps(tmp_10_1, _mm256_set1_ps(fused_s_10_1), sum_packed_fp_10);
            extra_sum_fp_10 += sum_a_1_fused_0 * min_b_0_0;
            extra_sum_fp_10 += sum_a_1_fused_1 * min_b_0_1;

            __m256 tmp_11_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j1, a_pack_int8_low_1);
            __m256 tmp_11_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high_1);
            sum_packed_fp_11 = _mm256_fmadd_ps(tmp_11_0, _mm256_set1_ps(fused_s_11_0), sum_packed_fp_11);
            sum_packed_fp_11 = _mm256_fmadd_ps(tmp_11_1, _mm256_set1_ps(fused_s_11_1), sum_packed_fp_11);
            extra_sum_fp_11 += sum_a_1_fused_0 * min_b_1_0;
            extra_sum_fp_11 += sum_a_1_fused_1 * min_b_1_1;

            __m256 tmp_12_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j2, a_pack_int8_low_1);
            __m256 tmp_12_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j2, a_pack_int8_high_1);
            sum_packed_fp_12 = _mm256_fmadd_ps(tmp_12_0, _mm256_set1_ps(fused_s_12_0), sum_packed_fp_12);
            sum_packed_fp_12 = _mm256_fmadd_ps(tmp_12_1, _mm256_set1_ps(fused_s_12_1), sum_packed_fp_12);
            extra_sum_fp_12 += sum_a_1_fused_0 * min_b_2_0;
            extra_sum_fp_12 += sum_a_1_fused_1 * min_b_2_1;

            __m256 tmp_13_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j3, a_pack_int8_low_1);
            __m256 tmp_13_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j3, a_pack_int8_high_1);
            sum_packed_fp_13 = _mm256_fmadd_ps(tmp_13_0, _mm256_set1_ps(fused_s_13_0), sum_packed_fp_13);
            sum_packed_fp_13 = _mm256_fmadd_ps(tmp_13_1, _mm256_set1_ps(fused_s_13_1), sum_packed_fp_13);
            extra_sum_fp_13 += sum_a_1_fused_0 * min_b_3_0;
            extra_sum_fp_13 += sum_a_1_fused_1 * min_b_3_1;

            // Row 2
            __m256 tmp_20_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j0, a_pack_int8_low_2);
            __m256 tmp_20_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j0, a_pack_int8_high_2);
            sum_packed_fp_20 = _mm256_fmadd_ps(tmp_20_0, _mm256_set1_ps(fused_s_20_0), sum_packed_fp_20);
            sum_packed_fp_20 = _mm256_fmadd_ps(tmp_20_1, _mm256_set1_ps(fused_s_20_1), sum_packed_fp_20);
            extra_sum_fp_20 += sum_a_2_fused_0 * min_b_0_0;
            extra_sum_fp_20 += sum_a_2_fused_1 * min_b_0_1;

            __m256 tmp_21_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j1, a_pack_int8_low_2);
            __m256 tmp_21_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high_2);
            sum_packed_fp_21 = _mm256_fmadd_ps(tmp_21_0, _mm256_set1_ps(fused_s_21_0), sum_packed_fp_21);
            sum_packed_fp_21 = _mm256_fmadd_ps(tmp_21_1, _mm256_set1_ps(fused_s_21_1), sum_packed_fp_21);
            extra_sum_fp_21 += sum_a_2_fused_0 * min_b_1_0;
            extra_sum_fp_21 += sum_a_2_fused_1 * min_b_1_1;

            __m256 tmp_22_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j2, a_pack_int8_low_2);
            __m256 tmp_22_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j2, a_pack_int8_high_2);
            sum_packed_fp_22 = _mm256_fmadd_ps(tmp_22_0, _mm256_set1_ps(fused_s_22_0), sum_packed_fp_22);
            sum_packed_fp_22 = _mm256_fmadd_ps(tmp_22_1, _mm256_set1_ps(fused_s_22_1), sum_packed_fp_22);
            extra_sum_fp_22 += sum_a_2_fused_0 * min_b_2_0;
            extra_sum_fp_22 += sum_a_2_fused_1 * min_b_2_1;

            __m256 tmp_23_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j3, a_pack_int8_low_2);
            __m256 tmp_23_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j3, a_pack_int8_high_2);
            sum_packed_fp_23 = _mm256_fmadd_ps(tmp_23_0, _mm256_set1_ps(fused_s_23_0), sum_packed_fp_23);
            sum_packed_fp_23 = _mm256_fmadd_ps(tmp_23_1, _mm256_set1_ps(fused_s_23_1), sum_packed_fp_23);
            extra_sum_fp_23 += sum_a_2_fused_0 * min_b_3_0;
            extra_sum_fp_23 += sum_a_2_fused_1 * min_b_3_1;

            // Row 3
            __m256 tmp_30_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j0, a_pack_int8_low_3);
            __m256 tmp_30_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j0, a_pack_int8_high_3);
            sum_packed_fp_30 = _mm256_fmadd_ps(tmp_30_0, _mm256_set1_ps(fused_s_30_0), sum_packed_fp_30);
            sum_packed_fp_30 = _mm256_fmadd_ps(tmp_30_1, _mm256_set1_ps(fused_s_30_1), sum_packed_fp_30);
            extra_sum_fp_30 += sum_a_3_fused_0 * min_b_0_0;
            extra_sum_fp_30 += sum_a_3_fused_1 * min_b_0_1;

            __m256 tmp_31_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j1, a_pack_int8_low_3);
            __m256 tmp_31_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j1, a_pack_int8_high_3);
            sum_packed_fp_31 = _mm256_fmadd_ps(tmp_31_0, _mm256_set1_ps(fused_s_31_0), sum_packed_fp_31);
            sum_packed_fp_31 = _mm256_fmadd_ps(tmp_31_1, _mm256_set1_ps(fused_s_31_1), sum_packed_fp_31);
            extra_sum_fp_31 += sum_a_3_fused_0 * min_b_1_0;
            extra_sum_fp_31 += sum_a_3_fused_1 * min_b_1_1;

            __m256 tmp_32_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j2, a_pack_int8_low_3);
            __m256 tmp_32_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j2, a_pack_int8_high_3);
            sum_packed_fp_32 = _mm256_fmadd_ps(tmp_32_0, _mm256_set1_ps(fused_s_32_0), sum_packed_fp_32);
            sum_packed_fp_32 = _mm256_fmadd_ps(tmp_32_1, _mm256_set1_ps(fused_s_32_1), sum_packed_fp_32);
            extra_sum_fp_32 += sum_a_3_fused_0 * min_b_2_0;
            extra_sum_fp_32 += sum_a_3_fused_1 * min_b_2_1;

            __m256 tmp_33_0 = mul_sum_us8_pairs_float(b_pack_int8_low_j3, a_pack_int8_low_3);
            __m256 tmp_33_1 = mul_sum_us8_pairs_float(b_pack_int8_high_j3, a_pack_int8_high_3);
            sum_packed_fp_33 = _mm256_fmadd_ps(tmp_33_0, _mm256_set1_ps(fused_s_33_0), sum_packed_fp_33);
            sum_packed_fp_33 = _mm256_fmadd_ps(tmp_33_1, _mm256_set1_ps(fused_s_33_1), sum_packed_fp_33);
            extra_sum_fp_33 += sum_a_3_fused_0 * min_b_3_0;
            extra_sum_fp_33 += sum_a_3_fused_1 * min_b_3_1;
        }

        // Store results for all 16 output elements
    ...
    // Handle remaining rows/columns when block_m or block_n isn't divisible by 4
    // (This part would need to be implemented similarly to the original kernel)
}
