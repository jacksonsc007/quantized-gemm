            ...
            for (int p = 0; p < K; p += 2 * Q_BLK_SIZE) 
            {
                ...
                for (int ii = 0; ii < 4; ++ii) {
                    ...
                    for (int jj = 0; jj < 4; ++jj) {
                        ...
                        volatile __m256 tmp1 =     mul_sum_us8_pairs_float(b_pack_int8_high [ jj ], a_pack_int8 [ ii ] [ 1 ] );
                        volatile __m256 tmp2 =     mul_sum_us8_pairs_float(b_pack_int8_high [ jj ], a_pack_int8 [ ii ] [ 1 ] );
