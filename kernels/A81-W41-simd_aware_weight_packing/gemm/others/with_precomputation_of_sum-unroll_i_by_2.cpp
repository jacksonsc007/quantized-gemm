    ...
    float* C, const int block_m, const int block_n, const int block_k)
{
    ...
    for (int j = 0; j < block_n; ++j)
    {
        ...
        for (int p = 0; p < block_k; p += 2 * Q_BLK_SIZE)
        {
            ...
            // Load scale factors for both i iterations
            ...
            // Load B data (shared between both i iterations)
            ...
            extra_sum_fp_0 += sum_a_0_fused_0 * min_b_0;
            extra_sum_fp_0 += sum_a_0_fused_1 * min_b_1;
            ...
            extra_sum_fp_1 += sum_a_1_fused_0 * min_b_0;
            extra_sum_fp_1 += sum_a_1_fused_1 * min_b_1;
        }
        
        // Store results for both i iterations
