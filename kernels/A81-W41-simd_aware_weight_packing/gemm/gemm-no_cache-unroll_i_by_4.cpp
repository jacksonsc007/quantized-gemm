    ...
    const int M, const int N, const int K) 
{
    ...
    for (int j = 0; j < N; j++)
    {
        ...
        for (int p = 0; p < K; p += 2 * Q_BLK_SIZE)
        {
            ...
            float sA_2_0 = *SA(i + 2, block_idx, K/Q_BLK_SIZE);
            float sA_2_1 = *SA(i + 2, block_idx + 1, K/Q_BLK_SIZE);
            float sA_3_0 = *SA(i + 3, block_idx, K/Q_BLK_SIZE);
            float sA_3_1 = *SA(i + 3, block_idx + 1, K/Q_BLK_SIZE);
            ...
            float fused_s_2_0 = sA_2_0 * sB_0;
            float fused_s_2_1 = sA_2_1 * sB_1;
            float fused_s_3_0 = sA_3_0 * sB_0;
            float fused_s_3_1 = sA_3_1 * sB_1;
            ...
            float sum_a_2_0_fused = *ScaledSumA(i + 2, block_idx, K / Q_BLK_SIZE);
            float sum_a_2_1_fused = *ScaledSumA(i + 2, block_idx + 1, K / Q_BLK_SIZE);
            float sum_a_3_0_fused = *ScaledSumA(i + 3, block_idx, K / Q_BLK_SIZE);
            float sum_a_3_1_fused = *ScaledSumA(i + 3, block_idx + 1, K / Q_BLK_SIZE);
            ...
            __m256i a_pack_int8_low_2 = _mm256_loadu_si256( (__m256i *) A(i + 2, p, K));
            __m256i a_pack_int8_high_2 = _mm256_loadu_si256( (__m256i *) A(i + 2, p + Q_BLK_SIZE, K));
            __m256i a_pack_int8_low_3 = _mm256_loadu_si256( (__m256i *) A(i + 3, p, K));
            __m256i a_pack_int8_high_3 = _mm256_loadu_si256( (__m256i *) A(i + 3, p + Q_BLK_SIZE, K));
            ...
            __m256 tmp_2_0 = mul_sum_us8_pairs_float(b_pack_int8_low, a_pack_int8_low_2);
            __m256 tmp_2_1 = mul_sum_us8_pairs_float(b_pack_int8_high, a_pack_int8_high_2);
            __m256 tmp_3_0 = mul_sum_us8_pairs_float(b_pack_int8_low, a_pack_int8_low_3);
            __m256 tmp_3_1 = mul_sum_us8_pairs_float(b_pack_int8_high, a_pack_int8_high_3);
            ...
            sum_packed_fp_2 = _mm256_fmadd_ps(tmp_2_0, _mm256_set1_ps(fused_s_2_0), sum_packed_fp_2);
            sum_packed_fp_2 = _mm256_fmadd_ps(tmp_2_1, _mm256_set1_ps(fused_s_2_1), sum_packed_fp_2);
            sum_packed_fp_3 = _mm256_fmadd_ps(tmp_3_0, _mm256_set1_ps(fused_s_3_0), sum_packed_fp_3);
            sum_packed_fp_3 = _mm256_fmadd_ps(tmp_3_1, _mm256_set1_ps(fused_s_3_1), sum_packed_fp_3);
            ...
            extra_sum_fp_2 += sum_a_2_0_fused * min_b_0;
            extra_sum_fp_2 += sum_a_2_1_fused * min_b_1;
            extra_sum_fp_3 += sum_a_3_0_fused * min_b_0;
            extra_sum_fp_3 += sum_a_3_1_fused * min_b_1;
        }
